...
2. Running as a Docker container using `ghcr.io/miramar-labs/github-runner:latest`
...
[github-actions-hello](https://github.com/miramar-labs/github-actions-hello) at `/home/aaron/git-miramar-labs/github-actions-hello` contains the runner image (`ghcr.io/miramar-labs/github-runner`), runner launch scripts, and the textlyze app pipeline. This repo was created from that project.
